# Generated by Django 5.2.4 on 2025-10-18 13:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(choices=[('building', 'Property'), ('land', 'Lands'), ('electronics', 'Electronics'), ('fashion', 'Fashion'), ('car', 'Vehicles'), ('wrench', 'Services'), ('briefcase', 'Jobs'), ('scissors', 'Beauty & Salons'), ('paint-brush', 'Decoration')], default='tag', max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='User',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_type', models.CharField(choices=[('approval', 'Ad Approved'), ('rejection', 'Ad Rejected'), ('featured', 'Ad Featured'), ('info', 'Information'), ('warning', 'Warning'), ('comment', 'New Comment'), ('reply', 'New Reply')], max_length=20)),
                ...
                ('comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='notifications', to='base.comment')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ad', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ratings', to='base.ad')),
